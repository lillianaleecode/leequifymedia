...
function Header() {
    ...
    return (
        <div className="shadow-sm border-b bg-white sticky top-0 z-50">
            <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto"> {/*not working this className for some reason, check later*/}
                {/*Left Logo*/}
                ...
                <div className="max-w-xs">
                    <div className="relative mt-1 p-3 rounded-md">
                        ...
                        sm:text-sm border-gray-300 focus:ring-black focus:border-black rounded-lg"
                        type="text" 
                        placeholder="Search" />
