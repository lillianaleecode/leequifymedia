...
import {ref,downloadURL, uploadString, getDownloadURL } from "@firebase/storage"
...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //1) creating post and add to firestore
        //2) get the post ID of the new post created
        //3) upload image to firebase
        //4) get a url from fb and update image with this url
